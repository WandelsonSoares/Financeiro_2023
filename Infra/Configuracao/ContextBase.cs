...
namespace Infra.Configuracao
{
    public class ContextBase : IdentityDbContext<ApplicationUser>
    {
        ...
        {
            return "Data Source=LAPTOP-LENOVO-1;Initial Catalog=FINANCEIRO_2023;Integrated Security=False;User ID=sa;Password=dev@2022;Connect Timeout=15;Encrypt=False;TrustServerCertificate=False";
