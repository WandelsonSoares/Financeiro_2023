...
namespace WebApi.Controllers
{
    ...
    public class UsuarioSistemaFinanceiroController : ControllerBase
    {
        ...
        public async Task<object> CadastrarUsuarioNoSistema(int idSistema, string emailUsuario)
        {
            try
            {
            await _IUsuarioSistemaFinanceiroServico.CadastrarUsuarioSistemaFinanceiro(
        ...
        public async Task<object> DeleteUsuarioSistemaFinanceiro(int id)
        {
            try
            {
                var usuarioSistemaFianceiro = await _InterfaceUsuarioSistemaFinanceiro.GetEntityById(id);

                await _InterfaceUsuarioSistemaFinanceiro.Delete(usuarioSistemaFianceiro);
            }
            catch (Exception)
            {
                return Task.FromResult(false);
